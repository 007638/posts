...
export default function Profile() {
  ...
  const [post, setPost] = useState(0); //变量post存帖子总数，初始为0
  ...
  useEffect(()=>{
    ...
    fetch(`http://172.20.13.32:8099/api/profile?user_id=${user.id}`)//向后端发送请求，要这个用户的信息
  ...
  return (
    <div style={{width:"600px",margin:"0 auto",padding:"20px"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-around",top:"20px"}}>
        <div onClick={() =>navigate('/my/posts')} style={{textAlign:"center"}}>
